    ...
    group("a color that's", () {
      ...
      group("hsl", () {
        group("without alpha:", () {
          group("hue", () {
            test("0", () async {
              expect(await _deprotofy(_hsl(0, 50, 50, 1.0)),
                  "hsl(0deg, 50%, 50%)");
            });
          ...
          group("saturation", () {
            test("0", () async {
              expect(
                  await _deprotofy(_hsl(0, 0, 50, 1.0)), "hsl(0deg, 0%, 50%)");
            });

            test("100", () async {
              expect(await _deprotofy(_hsl(0, 100, 50, 1.0)),
                  "hsl(0deg, 100%, 50%)");
            });

            test("in the middle", () async {
              expect(await _deprotofy(_hsl(0, 42, 50, 1.0)),
                  "hsl(0deg, 42%, 50%)");
            });
          });
          ...
          group("lightness", () {
            test("0", () async {
              expect(
                  await _deprotofy(_hsl(0, 50, 0, 1.0)), "hsl(0deg, 50%, 0%)");
            });

            test("100", () async {
              expect(await _deprotofy(_hsl(0, 50, 100, 1.0)),
                  "hsl(0deg, 50%, 100%)");
            });

            test("in the middle", () async {
              expect(await _deprotofy(_hsl(0, 50, 42, 1.0)),
                  "hsl(0deg, 50%, 42%)");
            });
          });
        });
